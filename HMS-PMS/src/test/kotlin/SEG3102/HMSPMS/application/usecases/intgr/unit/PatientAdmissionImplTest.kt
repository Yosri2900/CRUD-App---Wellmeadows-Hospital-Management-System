package SEG3102.HMSPMS.application.usecases.unit
...
@SpringBootTest
internal class PatientAdmissionImplTest {
    ...
    lateinit var prescribeMedication: PrescribeMedication

    lateinit var patientAdmission: PatientAdmission

    @Test
    fun patient_admission() {
...
//        val res = prescribeMedication.prescribeMedicationToPatient("Dr.Martin", "1", PrescriptionCreateDTO(
//                "voodoo medication",
//                4,
//                4,
//                "",
//                "swallowing with juice",
//                Date(),
//                Date(),
//        ))
//        Assertions.assertThat(res).isFalse()

        val admission = patientAdmission.admitPatient("johndoe1",
                AdmissionRequest(
                        "1",
                        "0001",
                        "broken foot",
        ...
        Assertions.assertThat(admission).isFalse()
    }
