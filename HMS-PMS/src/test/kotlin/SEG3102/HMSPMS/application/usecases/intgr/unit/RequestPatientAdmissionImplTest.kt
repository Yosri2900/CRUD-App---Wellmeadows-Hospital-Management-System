...
class RequestPatientAdmissionImplTest {
    ...
    lateinit var requestPatientAdmission: RequestPatientAdmission

    @Test
    fun see_admitted_patients() {
...
//        Assertions.assertThat(res).isFalse()
        ...
        val admission = requestPatientAdmission.requestPatientAdm("1",
                RequestCreateDTO("broken foot",
                        8,
                        "0001",
                        "1",
                        "7-05-2023",
...
//                null
        ...
        Assertions.assertThat(admission).isTrue()
    }
}